...
function renderActions(d) {
    ...
    html += '<button class="layui-btn layui-btn-primary layui-btn-sm" lay-event="view"><i class="layui-icon layui-icon-read"></i></button>';

    if (d.status === '待分配') {
        html += '<button class="layui-btn claim-btn layui-btn-sm" lay-event="claim"><i class="layui-icon layui-icon-ok"></i>认领</button>';
    } else {
        html += '<button class="layui-btn layui-btn-sm claimed-btn" type="button">已认领</button>';
    }
