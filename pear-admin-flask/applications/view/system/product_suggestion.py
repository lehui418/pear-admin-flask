...
def main():
    ...
    if request.args.get('mobile') == '1':
        return render_template('mobile/product_suggestion/main.html')
...
def add_view():
    # 判断是否移动端访问
    if request.args.get('mobile') == '1':
        return render_template('mobile/product_suggestion/add.html')
...
def view_view(suggestion_id):
    ...
    # 判断是否移动端访问
    if request.args.get('mobile') == '1':
        return render_template('mobile/product_suggestion/view.html', suggestion=suggestion)
...
def edit_view(suggestion_id):
    ...
    if current_user.username == 'admin':
        ...
        # 判断是否移动端访问
        if request.args.get('mobile') == '1':
            return render_template('mobile/product_suggestion/edit.html', 
    ...
    # 判断是否移动端访问
    if request.args.get('mobile') == '1':
        return render_template('mobile/product_suggestion/edit.html', suggestion=suggestion)
